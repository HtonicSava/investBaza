        ...
        <div class="resources__item item">
          ...
          <div v-if="tabs.card">
            ...
            <div class="item__button item__button-card">
              <ibButton
                @callback="openSuccessWindow('outMoney')"
