<template>
  <div class="questions">
      ...
      <div class="questions__content">
          <div class="form">
              <input class="form__name" type="text" name="" id="" placeholder="Ваше имя">
              <input class="form__number" type="number" name="" id="" placeholder="Телефон">
              <textarea class="form__question" placeholder="Вопрос"/>
              <div class="form__button">
                  <CusButton :color="'red'" :text="'Получить консультацию'" />
              </div>
              <input type="checkbox" class="custom-checkbox" id="check" name="happy" value="yes">
              <label for="check">Я соглашаюсь с правилами <a href="#">&nbsp; политики конфиденциальности</a> </label>
          </div>
      </div>
  </div>
</template>
